...
\section{Geräte}
%---
%Was ist mit Kommunikation, wie in 'State of the Art' auf S.11 beschrieben: Vehicle-to-vehicle communication, vehicle-to-infrastructure communication etc. -- wäre das nicht auch ein relevanter Angriffsvektor? (Haben wir Quellen?) \j

\section{Vorgehen}
%Nur als Vorschlag: Der Ablauf, wie man sich üblicherweise zugriff verschafft. Z.B. erst eine Sicherheitslücke wie Bluetooth nutzen, Shell öffnen, diesdas, ->Zugriff auf ... \j
\section{Beispiele}
...
Außerdem wurden viele Attacken erst möglich, da auf den ECUs telnetd, ftp und vi vorinstalliert waren, ohne dass sie im gewöhnlichen Betrieb notwendig wären. In der von (QUELLE 'woot15' Foster et al.) untersuchten TCU waren die Dienste ebenfalls aktiviert und das Gerät war durch eine aktive WAN-Verbindung (via 2G-Modem) sogar von Google und Shodan indiziert und somit sehr offen zugänglich.\par
% remote attack surfaces S.90f
Da sich Technik ständig ändert, wird es nie 100\% sichere Schnittstellen geben, schreiben die Autoren von (QUELLE 'remote attack surfaces') Allerdings müssen sich parallel zur Technik auch die Sicherheitsmaßnahmen, um sie zu schützen, weiterentwickeln.\par
